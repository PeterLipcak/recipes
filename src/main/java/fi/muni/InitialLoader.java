...
//        List<Recipe> compareRecipes = recipeDAO.findAll();
//
//        recipes.stream().forEach(recipe -> {
//            int i = 0;
//            compareRecipes.stream().forEach(compRecipe -> {
//                if(compRecipe != recipe)
//                {
//                    RecipeDifference recipeDifference = new RecipeDifference(recipe, compRecipe);
//                    recipeDifferenceDAO.save(recipeDifference);
//                }
//            });
//            i++
